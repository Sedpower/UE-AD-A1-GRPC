...
class MovieStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMovieByRating = channel.unary_unary(
        ...
        self.PutRateByMovieId = channel.unary_unary(
                '/Movie/PutRateByMovieId',
                request_serializer=movie__pb2.MovieIdRating.SerializeToString,
                response_deserializer=movie__pb2.MovieData.FromString,
                )
        self.DeleteByMovieId = channel.unary_unary(
                '/Movie/DeleteByMovieId',
                request_serializer=movie__pb2.MovieID.SerializeToString,
...
def add_MovieServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMovieByRating': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMovieByRating,
            ...
            'PutRateByMovieId': grpc.unary_unary_rpc_method_handler(
                    servicer.PutRateByMovieId,
                    request_deserializer=movie__pb2.MovieIdRating.FromString,
                    response_serializer=movie__pb2.MovieData.SerializeToString,
            ),
            'DeleteByMovieId': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteByMovieId,
                    request_deserializer=movie__pb2.MovieID.FromString,
...
class Movie(object):
    ...
    def GetMovieByRating(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Movie/GetMovieByRating',
    ...
    def PutRateByMovieId(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Movie/PutRateByMovieId',
    ...
    def DeleteByMovieId(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Movie/DeleteByMovieId',
            movie__pb2.MovieID.SerializeToString,
